...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            Cxt.get().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS));
        } else {
            Cxt.get().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS));
        }
    }
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm = (ConnectivityManager) Cxt.get()
...
//    }
    ...
    public static boolean getDataEnabled() {
        try {
            TelephonyManager tm = (TelephonyManager) Cxt.get().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) Cxt.get().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
